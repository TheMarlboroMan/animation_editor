...
file_browser::file_browser(
	...
	//Mount layout...
	layout.map_font("main", ttf_manager.get(animation_editor::definitions::main_font_name, animation_editor::definitions::main_font_size));
...
void file_browser::solve(
	bool _result,
	const std::string& _choice
) {

	intra_success=_result;
	intra_result=_choice;

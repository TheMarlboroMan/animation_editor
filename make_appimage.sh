...
then
	...
	then
		...
		entrypointpath="./build/build/animation_editor"
...
$linuxdeploypath --executable $entrypointpath --appdir AppDir -i ./linuxdeploy/animation_editor.png -d ./linuxdeploy/animation_editor.desktop --output appimage
exit 0
